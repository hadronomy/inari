...
def create_windows_service_class(
    *,
    ...
    class InariWindowsService(win32serviceutil.ServiceFramework):
        ...
        _exe_args_ = "-m inari.windows_service"
    ...
    InariWindowsService.__module__ = __name__
    globals()["InariWindowsService"] = InariWindowsService
    return InariWindowsService
