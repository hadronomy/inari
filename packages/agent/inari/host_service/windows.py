...
class WindowsServiceManager:
    ...
    def install(self) -> str:
        ...
        from .windows_entrypoint import (
    ...
    def uninstall(self) -> str:
        win32serviceutil = self._serviceutil()
        from .windows_entrypoint import create_windows_service_class
        ...
        win32serviceutil.HandleCommandLine(
            service_class,
            argv=["inari-windows-service", "remove"],
        )
    ...
    def definition(self) -> ServiceDefinition:
        content = "\n".join(
            [
                ...
                "service_entrypoint = python -m inari.host_service.windows_entrypoint",
    ...
    def _service_modules(self) -> tuple[Any, Any]:
        from .windows_entrypoint import _import_pywin32_service_modules
